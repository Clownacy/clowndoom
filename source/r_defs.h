...
#define MAXDRAWSEGS             4096 /* Previously 256, but Plutonia's MAP24 exceeds this when rendering in HD. */
...
#define LIGHTAMPCOLORMAP        (NUMLIGHTCOLORMAPS+1)
#define FUZZCOLORMAPS           (NUMLIGHTCOLORMAPS+2)
