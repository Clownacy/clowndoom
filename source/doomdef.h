...
#ifdef LOW_END
#define MAXIMUM_RESOLUTION_SCALE 1
#define MAXIMUM_SCREENHEIGHT ORIGINAL_SCREEN_HEIGHT
#define MAXIMUM_SCREENWIDTH  ORIGINAL_SCREEN_WIDTH
#else
...
#define X_LEFT(x) (x)
#define X_RIGHT(x) (SCREENWIDTH - ((ORIGINAL_SCREEN_WIDTH - (x)) * HUD_SCALE))
...
extern fixed_t horizontal_fov_correction, vertical_fov_correction;

#define HORIZONTAL_FOV_CORRECTION(x) FixedMul(x, horizontal_fov_correction)
#define VERTICAL_FOV_CORRECTION(x) FixedMul(x, vertical_fov_correction)
